...
export default function AboutPage() {
  ...
  return (
    <AboutContainer>
      ...
      <StorySection>
        <StoryHeading>Find me online</StoryHeading>
        <SocialLinks>
          <SocialIcon href="https://github.com/joshwcomeau" target="_blank" rel="noopener noreferrer" title="GitHub">
            <span role="img" aria-label="GitHub">🐙</span>
          </SocialIcon>
          <SocialIcon href="https://twitter.com/joshwcomeau" target="_blank" rel="noopener noreferrer" title="Twitter">
            <span role="img" aria-label="Twitter">🐦</span>
          </SocialIcon>
          <SocialIcon href="https://www.linkedin.com/in/joshwcomeau/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
            <span role="img" aria-label="LinkedIn">💼</span>
          </SocialIcon>
          <SocialIcon href="https://bsky.app/profile/joshwcomeau.com" target="_blank" rel="noopener noreferrer" title="BlueSky">
            <span role="img" aria-label="BlueSky">🌤️</span>
          </SocialIcon>
        </SocialLinks>
      </StorySection>
    </AboutContainer>
